...
'caret';a[c]=0};d.prototype.controller.$inject=['$scope','$element','$attrs'];d.prototype.link=function(a,g,h,b){g.bind('keydown keyup click',function(){a.$apply(function(){a[b.a()]=b.b()})});a.$watch(function(){return a[b.a()]},function(a){b.c(~~a)})};angular.module('leodido.caretAware',[]).directive('caretAware',function(){var a=new d;return{restrict:'A',require:'caretAware',controller:a.controller,link:a.link}});})();
