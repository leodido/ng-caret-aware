...
return a.text.length-c}};h=k.caretAware||'caret';a[h]=0};d.prototype.controller.$inject=['$scope','$element','$attrs','$timeout'];d.prototype.link=function(a,g,k,c){g.bind('keydown keyup click',function(){a.$apply(function(){a[c.a()]=c.b()})});a.$watch(function(){return a[c.a()]},function(a){c.c(~~a)})};angular.module('leodido.caretAware',[]).directive('caretAware',function(){var a=new d;return{restrict:'A',controller:a.controller,link:a.link}});})();
